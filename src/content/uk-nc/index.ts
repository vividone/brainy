...
export const ukNc: Curriculum = {
  ...
  subjects: [
    ...
    },
    {
      ...
      color: 'emerald',
      available: false,
      comingSoon: 'Key Stage 1 and 2 science.',
      plannedTopics: ['Living things', 'Materials', 'Forces', 'Light & sound', 'Earth & space'],
      strands: [],
    },
    {
      id: 'technology',
      ...
      color: 'slate',
      available: false,
      comingSoon: 'Tools, materials, structures and computing basics.',
      plannedTopics: ['Tools & safety', 'Materials', 'Structures', 'Mechanisms', 'Computing basics'],
      strands: [],
    },
    {
      id: 'social',
      ...
      color: 'orange',
      available: false,
      comingSoon: 'Geography, history and citizenship.',
      plannedTopics: ['UK geography', 'Continents & oceans', 'British history', 'Citizenship', 'Maps'],
      strands: [],
    },
  ],
}
