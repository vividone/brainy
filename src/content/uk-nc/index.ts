...
export const ukNc: Curriculum = {
  ...
  locale: ukLocale,
  yearBands: [
    { id: 'y1', label: 'Year 1', short: 'Y1', ageRange: [5, 6] },
    { id: 'y2', label: 'Year 2', short: 'Y2', ageRange: [6, 7] },
    { id: 'y3', label: 'Year 3', short: 'Y3', ageRange: [7, 8] },
    { id: 'y4', label: 'Year 4', short: 'Y4', ageRange: [8, 9] },
    { id: 'y5', label: 'Year 5', short: 'Y5', ageRange: [9, 10] },
    { id: 'y6', label: 'Year 6', short: 'Y6', ageRange: [10, 12] },
  ],
  subjects: [
    {
      id: 'maths',
      ...
      strands: [
        {
          ...
          theme: 'market',
          skills: [...ukY1Number, ...ukY2Number, numbersTo1000, placeValue, compareOrder, ...ukY4Number, ...ukY5Number, ...ukY6Number],
        },
        {
          id: 'uk.maths.calc',
          ...
          theme: 'falls',
          skills: [...ukY1Calculation, ...ukY2Calculation, addSubtract, timesTables, ...ukY4Calculation, ...ukY5Calculation, ...ukY6Calculation],
        },
        {
          ...
          theme: 'grove',
          skills: [...ukY1Fractions, ...ukY2Fractions, ...ukY4Fractions, ...ukY5Fractions, ...ukY6Fractions],
        },
        {
          id: 'uk.maths.measure',
          name: 'Measure Bay',
          ...
          theme: 'bay',
          skills: [...ukY1Measurement, ...ukY2Measurement, poundsPence, ...ukY4Measurement, ...ukY6Measurement],
        },
        {
          id: 'uk.maths.shapes',
          name: 'Shape City',
          ...
          theme: 'city',
          skills: [...ukY2Geometry, ...ukY4Geometry],
        },
        {
          id: 'uk.maths.data',
          name: 'Data Beach',
          ...
          theme: 'beach',
          skills: [...ukY4Statistics, ...ukY6Statistics],
        },
      ],
    },
    /*
    ...
    },
    {
      ...
      color: 'rose',
      available: false,
      comingSoon: 'Spelling, punctuation and grammar in the KS1/KS2 style.',
      plannedTopics: [
        'Word classes',
        'Tenses',
        'Punctuation',
    ...
    {
      id: 'science',
      name: 'Science & Design Technology',
      icon: '🔬',
      color: 'emerald',
      available: false,
      comingSoon: 'Key Stage 1 and 2 science, plus tools, materials and structures.',
      plannedTopics: [
        'Living things',
        'Materials',
        'Forces',
    ...
    },
    {
      ...
      color: 'orange',
      available: false,
      comingSoon: 'Maps, the UK, the continents and how places differ.',
      plannedTopics: ['UK geography', 'Continents & oceans', 'Maps & compass', 'Weather & climate', 'Rivers'],
      strands: [],
    },
    {
      id: 'history',
      ...
      color: 'stone',
      available: false,
      comingSoon: 'From the Romans to the present day.',
      plannedTopics: ['Ancient Britain', 'Romans', 'Anglo-Saxons & Vikings', 'Tudors', 'Victorians', 'World wars'],
      strands: [],
    },
    {
      id: 'computer',
      ...
      color: 'cyan',
      available: false,
      comingSoon: 'Algorithms, coding, and staying safe online.',
      plannedTopics: ['Algorithms', 'Debugging', 'Scratch basics', 'Online safety', 'Data & spreadsheets'],
      strands: [],
    },
  ],
}
