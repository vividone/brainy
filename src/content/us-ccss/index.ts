...
export const usCcss: Curriculum = {
  ...
  subjects: [
    ...
    comingSoon('science', 'Science', '🔬', 'emerald', 'NGSS-aligned elementary science.', [
      'Living things',
      'Matter',
      'Forces & motion',
      'Earth & space',
    ...
    comingSoon('technology', 'Technology & Engineering', '🔧', 'slate', 'Tools, design and computing basics.', [
      'Tools & safety',
      'Materials',
      'Simple machines',
      'Design process',
    ...
    comingSoon('social', 'Social Studies', '🌍', 'orange', 'Communities, geography, history and civics.', [
      'Communities',
      'US geography',
      'US history',
      'Civics & government',
