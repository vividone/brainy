      ...
      strands: [
        {
          ...
          theme: 'market',
          skills: [...usKNumber, ...usG1Number, numbersTo1000, placeValue, compareOrder, ...usG3Number, ...usG4Number, ...usG5Number],
        },
        {
          id: 'us.math.ops',
          ...
          theme: 'falls',
          skills: [...usKOps, ...usG1Ops, addSubtract, multiplication, ...usG3Ops, ...usG5Ops],
        },
        {
          ...
          theme: 'grove',
          skills: [...usG3Fractions, ...usG4Fractions, ...usG5Fractions],
        },
        {
          id: 'us.math.measure',
          name: 'Measure Bay',
          ...
          theme: 'bay',
          skills: [...usG1Measurement, dollarsCents, ...usG3Measurement, ...usG4Measurement, ...usG5Measurement],
        },
        {
          id: 'us.math.shapes',
          name: 'Shape City',
          ...
          theme: 'city',
          skills: [...usKGeometry, ...usG3Geometry, ...usG5Geometry],
        },
      ],
    },
    comingSoon(
